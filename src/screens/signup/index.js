      ...
      <View style={styles.mainContainer}>
        ...
        <Card style={{margin: 10, backgroundColor: '#fff'}}>
              ...
              <View
                  ...
                  <View>
                    ...
                    <View style={[styles.inputContainer, {marginTop: 10}]}>
                      <TextInput
                        ...
                        underlineColor={GOBALCOLOR.COLORS.BROWN}
                        activeOutlineColor={
                          errors.firmName && touched.firmName ? 'red' : 'black'
                        }
                      />
                    </View>
                    ...
                    <View style={[styles.inputContainer, {marginTop: 10}]}>
                      <TextInput
                        ...
                        placeholder="Firm Register Number"
                        style={styles.input}
                    ...
                    <View style={[styles.inputContainer, {marginTop: 10}]}>
                      <TextInput
                        ...
                        placeholder="Firm Branch Number"
                        style={styles.input}
                    ...
                    <View style={[styles.inputContainer, {marginTop: 10}]}>
                      <TextInput
                        ...
                        placeholder="Firm Office Address"
                        style={styles.input}
                        ...
                        outlineStyle={{borderWidth: 0.5}}
                        activeOutlineColor={
                          errors.firmfirmOfficeAddressBranchName &&
                          touched.firmfirmOfficeAddressBranchName
                            ? 'red'
                            : 'black'
                        }
                      />
                ...
                <View style={[styles.inputContainer, {marginTop: 10}]}>
                  <TextInput
                    ...
                    right={
                      <TextInput.Icon
                        icon={showCnfPassword ? 'eye-off' : 'eye'}
                        forceTextInputFocus={false}
                        iconColor={GOBALCOLOR.COLORS.BROWN}
                        style={{marginTop: 10}}
                        onPress={() => setCnfShowPassword(!showCnfPassword)}
                      />
                    }
                    activeUnderlineColor={GOBALCOLOR.COLORS.BROWN}
                    underlineColor={GOBALCOLOR.COLORS.BROWN}
          ...
          <Text style={styles.linkLabel}>
            already have an account? <Text style={styles.link}  onPress={() => props.navigation.navigate('SignInScreen')}>login here</Text>{' '}
          </Text>
        </Card>
        <ProgressScreen />
      </View>
